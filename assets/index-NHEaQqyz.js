...
void main() {
	...
	`}var cc=class extends ln{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ea(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
s=-\r
t=0 0\r
`},n.getDirection=function(e,t){let r=n.splitLines(e);for(let e=0;e<r.length;e++)switch(r[e]){case`a=sendrecv`:case`a=sendonly`:case`a=recvonly`:case`a=inactive`:return r[e].substring(2)}return t?n.getDirection(t):`sendrecv`},n.getKind=function(e){return n.splitLines(e)[0].split(` `)[0].substring(2)},n.isRejected=function(e){return e.split(` `,2)[1]===`0`},n.parseMLine=function(e){let t=n.splitLines(e)[0].substring(2).split(` `);return{kind:t[0],port:parseInt(t[1],10),protocol:t[2],fmt:t.slice(3).join(` `)}},n.parseOLine=function(e){let t=n.matchPrefix(e,`o=`)[0].substring(2).split(` `);return{username:t[0],sessionId:t[1],sessionVersion:parseInt(t[2],10),netType:t[3],addressType:t[4],address:t[5]}},n.isValidSDP=function(e){if(typeof e!=`string`||e.length===0)return!1;let t=n.splitLines(e);for(let e=0;e<t.length;e++)if(t[e].length<2||t[e].charAt(1)!==`=`)return!1;return!0},typeof t==`object`&&(t.exports=n)})),Dp=s({removeExtmapAllowMixed:()=>Pp,shimAddIceCandidateNullOrEmpty:()=>Fp,shimConnectionState:()=>Np,shimMaxMessageSize:()=>jp,shimParameterlessSetLocalDescription:()=>Ip,shimRTCIceCandidate:()=>kp,shimRTCIceCandidateRelayProtocol:()=>Ap,shimSendThrowTypeError:()=>Mp}),Op=l(Ep());function kp(e){if(!e.RTCIceCandidate||e.RTCIceCandidate&&`foundation`in e.RTCIceCandidate.prototype)return;let t=e.RTCIceCandidate;e.RTCIceCandidate=function(e){if(typeof e==`object`&&e.candidate&&e.candidate.indexOf(`a=`)===0&&(e=JSON.parse(JSON.stringify(e)),e.candidate=e.candidate.substring(2)),e.candidate&&e.candidate.length){let n=new t(e),r=Op.default.parseCandidate(e.candidate);for(let e in r)e in n||Object.defineProperty(n,e,{value:r[e]});return n.toJSON=function(){return{candidate:n.candidate,sdpMid:n.sdpMid,sdpMLineIndex:n.sdpMLineIndex,usernameFragment:n.usernameFragment}},n}return new t(e)},e.RTCIceCandidate.prototype=t.prototype,Ff(e,`icecandidate`,t=>(t.candidate&&Object.defineProperty(t,"candidate",{value:new e.RTCIceCandidate(t.candidate),writable:`false`}),t))}function Ap(e){!e.RTCIceCandidate||e.RTCIceCandidate&&`relayProtocol`in e.RTCIceCandidate.prototype||Ff(e,`icecandidate`,e=>{if(e.candidate){let t=Op.default.parseCandidate(e.candidate.candidate);t.type===`relay`&&(e.candidate.relayProtocol={0:`tls`,1:`tcp`,2:`udp`}[t.priority>>24])}return e})}function jp(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>102||t.browser===`firefox`&&t.version>=113)return;`sctp`in e.RTCPeerConnection.prototype||Object.defineProperty(e.RTCPeerConnection.prototype,"sctp",{get(){return this._sctp===void 0?null:this._sctp}});let n=function(e){if(!e||!e.sdp)return!1;let t=Op.default.splitSections(e.sdp);return t.shift(),t.some(e=>{let t=Op.default.parseMLine(e);return t&&t.kind===`application`&&t.protocol.indexOf(`SCTP`)!==-1})},r=function(e){let t=e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(t===null||t.length<2)return-1;let n=parseInt(t[1],10);return n===n?n:-1},i=function(e){let n=65536;return t.browser===`firefox`&&(n=t.version<57?e===-1?16384:2147483637:t.version<60?t.version===57?65535:65536:2147483637),n},a=function(e,n){let r=65536;t.browser===`firefox`&&t.version===57&&(r=65535);let i=Op.default.matchPrefix(e.sdp,`a=max-message-size:`);return i.length>0?r=parseInt(i[0].substring(19),10):t.browser===`firefox`&&n!==-1&&(r=2147483637),r},o=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(){if(this._sctp=null,t.browser===`chrome`&&t.version>=76){let{sdpSemantics:e}=this.getConfiguration();e===`plan-b`&&Object.defineProperty(this,"sctp",{get(){return this._sctp===void 0?null:this._sctp},enumerable:!0,configurable:!0})}if(n(arguments[0])){let e=r(arguments[0]),t=i(e),n=a(arguments[0],e),o;o=t===0&&n===0?1/0:t===0||n===0?Math.max(t,n):Math.min(t,n);let s={};Object.defineProperty(s,"maxMessageSize",{get(){return o}}),this._sctp=s}return o.apply(this,arguments)}}function Mp(e,t){if(!(e.RTCPeerConnection&&`createDataChannel`in e.RTCPeerConnection.prototype)||t.browser===`chrome`&&t.version>=149||t.browser===`firefox`&&t.version>60)return;function n(e,t){let n=e.send;e.send=function(){let r=arguments[0],i=r.length||r.size||r.byteLength;if(e.readyState===`open`&&t.sctp&&i>t.sctp.maxMessageSize)throw TypeError(`Message too large (can send a maximum of `+t.sctp.maxMessageSize+` bytes)`);return n.apply(e,arguments)}}let r=e.RTCPeerConnection.prototype.createDataChannel;e.RTCPeerConnection.prototype.createDataChannel=function(){let e=r.apply(this,arguments);return n(e,this),e},Ff(e,`datachannel`,e=>(n(e.channel,e.target),e))}function Np(e){if(!e.RTCPeerConnection||`connectionState`in e.RTCPeerConnection.prototype)return;let t=e.RTCPeerConnection.prototype;Object.defineProperty(t,"connectionState",{get(){return{completed:`connected`,checking:`connecting`}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0}),Object.defineProperty(t,"onconnectionstatechange",{get(){return this._onconnectionstatechange||null},set(e){this._onconnectionstatechange&&(this.removeEventListener(`connectionstatechange`,this._onconnectionstatechange),delete this._onconnectionstatechange),e&&this.addEventListener(`connectionstatechange`,this._onconnectionstatechange=e)},enumerable:!0,configurable:!0}),[`setLocalDescription`,`setRemoteDescription`].forEach(e=>{let n=t[e];t[e]=function(){return this._connectionstatechangepoly||(this._connectionstatechangepoly=e=>{let t=e.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;let n=new Event(`connectionstatechange`,e);t.dispatchEvent(n)}return e},this.addEventListener(`iceconnectionstatechange`,this._connectionstatechangepoly)),n.apply(this,arguments)}})}function Pp(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>=71||t.browser===`safari`&&t._safariVersion>=13.1)return;let n=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(t){if(t&&t.sdp&&t.sdp.indexOf(`
a=extmap-allow-mixed`)!==-1){let n=t.sdp.split(`
`).filter(e=>e.trim()!==`a=extmap-allow-mixed`).join(`
`);e.RTCSessionDescription&&t instanceof e.RTCSessionDescription?arguments[0]=new e.RTCSessionDescription({type:t.type,sdp:n}):t.sdp=n}return n.apply(this,arguments)}}function Fp(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.addIceCandidate;n&&n.length!==0&&(e.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(t.browser===`chrome`&&t.version<78||t.browser===`firefox`&&t.version<68||t.browser===`safari`)&&arguments[0]&&arguments[0].candidate===``?Promise.resolve():n.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function Ip(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.setLocalDescription;n&&n.length!==0&&(e.RTCPeerConnection.prototype.setLocalDescription=function(){let e=arguments[0]||{};if(typeof e!=`object`||e.type&&e.sdp)return n.apply(this,arguments);if(e={type:e.type,sdp:e.sdp},!e.type)switch(this.signalingState){case`stable`:case`have-local-offer`:case`have-remote-pranswer`:e.type=`offer`;break;default:e.type=`answer`}return e.sdp||e.type!==`offer`&&e.type!==`answer`?n.apply(this,[e]):(e.type===`offer`?this.createOffer:this.createAnswer).apply(this).then(e=>n.apply(this,[e]))})}function Lp({window:e}={},t={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){let n=Rf,r=Bf(e),i={browserDetails:r,commonShim:Dp,extractVersion:Pf,disableLog:If,disableWarnings:Lf,sdp:Op};switch(r.browser){case`chrome`:if(!qf||!ep||!t.shimChrome)return n(`Chrome shim is not included in this adapter release.`),i;if(r.version===null)return n(`Chrome shim can not determine version, not shimming.`),i;n(`adapter.js shimming chrome.`),i.browserShim=qf,Fp(e,r),Ip(e,r),Kf(e,r),Jf(e,r),ep(e,r),Yf(e,r),$f(e,r),Xf(e,r),Zf(e,r),tp(e,r),kp(e,r),Ap(e,r),Np(e,r),jp(e,r),Mp(e,r),Pp(e,r);break;case`firefox`:if(!ip||!op||!t.shimFirefox)return n(`Firefox shim is not included in this adapter release.`),i;n(`adapter.js shimming firefox.`),i.browserShim=ip,Fp(e,r),Ip(e,r),np(e,r),op(e,r),sp(e,r),ap(e,r),up(e,r),cp(e,r),lp(e,r),dp(e,r),fp(e,r),pp(e,r),mp(e,r),hp(e,r),kp(e,r),Np(e,r),jp(e,r),Mp(e,r);break;case`safari`:if(!gp||!t.shimSafari)return n(`Safari shim is not included in this adapter release.`),i;n(`adapter.js shimming safari.`),i.browserShim=gp,Fp(e,r),Ip(e,r),Sp(e,r),wp(e,r),yp(e,r),_p(e,r),vp(e,r),Cp(e,r),bp(e,r),Tp(e,r),kp(e,r),Ap(e,r),jp(e,r),Mp(e,r),Pp(e,r);break;default:n(`Unsupported browser!`)}return i}var Rp=Lp({window:typeof window>`u`?void 0:window});function zp(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var Bp=class{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{let t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU),i=0,a=0;for(;a<n;){let o=Math.min(n,a+this.chunkedMTU),s=e.slice(a,o),c={__peerData:this._dataCount,n:i,data:s,total:r};t.push(c),a=o,i++}return this._dataCount++,t}}};function Vp(e){let t=0;for(let n of e)t+=n.byteLength;let n=new Uint8Array(t),r=0;for(let t of e)n.set(t,r),r+=t.byteLength;return n}var Hp=Rp.default||Rp,Up=new class{isWebRTCSupported(){return typeof RTCPeerConnection<`u`}isBrowserSupported(){let e=this.getBrowser(),t=this.getVersion();return this.supportedBrowsers.includes(e)?e===`chrome`?t>=this.minChromeVersion:e===`firefox`?t>=this.minFirefoxVersion:e===`safari`&&!this.isIOS&&t>=this.minSafariVersion:!1}getBrowser(){return Hp.browserDetails.browser}getVersion(){return Hp.browserDetails.version||0}isUnifiedPlanSupported(){let e=this.getBrowser(),t=Hp.browserDetails.version||0;if(e===`chrome`&&t<this.minChromeVersion)return!1;if(e===`firefox`&&t>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!(`currentDirection`in RTCRtpTransceiver.prototype))return!1;let n,r=!1;try{n=new RTCPeerConnection,n.addTransceiver(`audio`),r=!0}catch{}finally{n&&n.close()}return r}toString(){return`Supports:
    browser:${this.getBrowser()}
    version:${this.getVersion()}
    isIOS:${this.isIOS}
    isWebRTCSupported:${this.isWebRTCSupported()}
    isBrowserSupported:${this.isBrowserSupported()}
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<`u`&&[`iPad`,`iPhone`,`iPod`].includes(navigator.platform),this.supportedBrowsers=[`firefox`,`chrome`,`safari`],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},Wp=e=>!e||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),Gp=()=>Math.random().toString(36).slice(2),Kp={iceServers:[{urls:`stun:stun.l.google.com:19302`},{urls:[`turn:eu-0.turn.peerjs.com:3478`,`turn:us-0.turn.peerjs.com:3478`],username:`peerjs`,credential:`peerjsp`}],sdpSemantics:`unified-plan`},qp=new class extends Bp{noop(){}blobToArrayBuffer(e,t){let n=new FileReader;return n.onload=function(e){e.target&&t(e.target.result)},n.readAsArrayBuffer(e),n}binaryStringToArrayBuffer(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer}isSecure(){return location.protocol===`https:`}constructor(...e){super(...e),this.CLOUD_HOST=`0.peerjs.com`,this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=Kp,this.browser=Up.getBrowser(),this.browserVersion=Up.getVersion(),this.pack=kf,this.unpack=Of,this.supports=function(){let e={browser:Up.isBrowserSupported(),webRTC:Up.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!e.webRTC)return e;let t;try{t=new RTCPeerConnection(Kp),e.audioVideo=!0;let n;try{n=t.createDataChannel(`_PEERJSTEST`,{ordered:!0}),e.data=!0,e.reliable=!!n.ordered;try{n.binaryType=`blob`,e.binaryBlob=!Up.isIOS}catch{}}catch{}finally{n&&n.close()}}catch{}finally{t&&t.close()}return e}(),this.validateId=Wp,this.randomToken=Gp}},Jp=`PeerJS: `,$=new class{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){let n=[Jp,...t];for(let e in n)n[e]instanceof Error&&(n[e]=`(`+n[e].name+`) `+n[e].message);e>=3?console.log(...n):e>=2?console.warn(`WARNING`,...n):e>=1&&console.error(`ERROR`,...n)}constructor(){this._logLevel=0}},Yp={},Xp=Object.prototype.hasOwnProperty,Zp=`~`;function Qp(){}Object.create&&(Qp.prototype=Object.create(null),new Qp().__proto__||(Zp=!1));function $p(e,t,n){this.fn=e,this.context=t,this.once=n||!1}function em(e,t,n,r,i){if(typeof n!=`function`)throw TypeError(`The listener must be a function`);var a=new $p(n,r||e,i),o=Zp?Zp+t:t;return e._events[o]?e._events[o].fn?e._events[o]=[e._events[o],a]:e._events[o].push(a):(e._events[o]=a,e._eventsCount++),e}function tm(e,t){--e._eventsCount===0?e._events=new Qp:delete e._events[t]}function nm(){this._events=new Qp,this._eventsCount=0}nm.prototype.eventNames=function(){var e=[],t,n;if(this._eventsCount===0)return e;for(n in t=this._events)Xp.call(t,n)&&e.push(Zp?n.slice(1):n);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e},nm.prototype.listeners=function(e){var t=Zp?Zp+e:e,n=this._events[t];if(!n)return[];if(n.fn)return[n.fn];for(var r=0,i=n.length,a=Array(i);r<i;r++)a[r]=n[r].fn;return a},nm.prototype.listenerCount=function(e){var t=Zp?Zp+e:e,n=this._events[t];return n?n.fn?1:n.length:0},nm.prototype.emit=function(e,t,n,r,i,a){var o=Zp?Zp+e:e;if(!this._events[o])return!1;var s=this._events[o],c=arguments.length,l,u;if(s.fn){switch(s.once&&this.removeListener(e,s.fn,void 0,!0),c){case 1:return s.fn.call(s.context),!0;case 2:return s.fn.call(s.context,t),!0;case 3:return s.fn.call(s.context,t,n),!0;case 4:return s.fn.call(s.context,t,n,r),!0;case 5:return s.fn.call(s.context,t,n,r,i),!0;case 6:return s.fn.call(s.context,t,n,r,i,a),!0}for(u=1,l=Array(c-1);u<c;u++)l[u-1]=arguments[u];s.fn.apply(s.context,l)}else{var d=s.length,f;for(u=0;u<d;u++)switch(s[u].once&&this.removeListener(e,s[u].fn,void 0,!0),c){case 1:s[u].fn.call(s[u].context);break;case 2:s[u].fn.call(s[u].context,t);break;case 3:s[u].fn.call(s[u].context,t,n);break;case 4:s[u].fn.call(s[u].context,t,n,r);break;default:if(!l)for(f=1,l=Array(c-1);f<c;f++)l[f-1]=arguments[f];s[u].fn.apply(s[u].context,l)}}return!0},nm.prototype.on=function(e,t,n){return em(this,e,t,n,!1)},nm.prototype.once=function(e,t,n){return em(this,e,t,n,!0)},nm.prototype.removeListener=function(e,t,n,r){var i=Zp?Zp+e:e;if(!this._events[i])return this;if(!t)return tm(this,i),this;var a=this._events[i];if(a.fn)a.fn===t&&(!r||a.once)&&(!n||a.context===n)&&tm(this,i);else{for(var o=0,s=[],c=a.length;o<c;o++)(a[o].fn!==t||r&&!a[o].once||n&&a[o].context!==n)&&s.push(a[o]);s.length?this._events[i]=s.length===1?s[0]:s:tm(this,i)}return this},nm.prototype.removeAllListeners=function(e){var t;return e?(t=Zp?Zp+e:e,this._events[t]&&tm(this,t)):(this._events=new Qp,this._eventsCount=0),this},nm.prototype.off=nm.prototype.removeListener,nm.prototype.addListener=nm.prototype.on,nm.prefixed=Zp,nm.EventEmitter=nm,Yp=nm;var rm={};zp(rm,`ConnectionType`,()=>im),zp(rm,`PeerErrorType`,()=>am),zp(rm,`BaseConnectionErrorType`,()=>om),zp(rm,`DataConnectionErrorType`,()=>sm),zp(rm,`SerializationType`,()=>cm),zp(rm,`SocketEventType`,()=>lm),zp(rm,`ServerMessageType`,()=>um);var im=function(e){return e.Data=`data`,e.Media=`media`,e}({}),am=function(e){return e.BrowserIncompatible=`browser-incompatible`,e.Disconnected=`disconnected`,e.InvalidID=`invalid-id`,e.InvalidKey=`invalid-key`,e.Network=`network`,e.PeerUnavailable=`peer-unavailable`,e.SslUnavailable=`ssl-unavailable`,e.ServerError=`server-error`,e.SocketError=`socket-error`,e.SocketClosed=`socket-closed`,e.UnavailableID=`unavailable-id`,e.WebRTC=`webrtc`,e}({}),om=function(e){return e.NegotiationFailed=`negotiation-failed`,e.ConnectionClosed=`connection-closed`,e}({}),sm=function(e){return e.NotOpenYet=`not-open-yet`,e.MessageToBig=`message-too-big`,e}({}),cm=function(e){return e.Binary=`binary`,e.BinaryUTF8=`binary-utf8`,e.JSON=`json`,e.None=`raw`,e}({}),lm=function(e){return e.Message=`message`,e.Disconnected=`disconnected`,e.Error=`error`,e.Close=`close`,e}({}),um=function(e){return e.Heartbeat=`HEARTBEAT`,e.Candidate=`CANDIDATE`,e.Offer=`OFFER`,e.Answer=`ANSWER`,e.Open=`OPEN`,e.Error=`ERROR`,e.IdTaken=`ID-TAKEN`,e.InvalidKey=`INVALID-KEY`,e.Leave=`LEAVE`,e.Expire=`EXPIRE`,e}({}),dm=`1.5.5`,fm=class extends Yp.EventEmitter{constructor(e,t,n,r,i,a=5e3){super(),this.pingInterval=a,this._disconnected=!0,this._messagesQueue=[];let o=e?`wss://`:`ws://`;this._baseUrl=o+t+`:`+n+r+`peerjs?key=`+i}start(e,t){this._id=e;let n=`${this._baseUrl}&id=${e}&token=${t}`;!this._socket&&this._disconnected&&(this._socket=new WebSocket(n+`&version=1.5.5`),this._disconnected=!1,this._socket.onmessage=e=>{let t;try{t=JSON.parse(e.data),$.log(`Server message received:`,t)}catch{$.log(`Invalid server message`,e.data);return}this.emit(lm.Message,t)},this._socket.onclose=e=>{this._disconnected||($.log(`Socket closed.`,e),this._cleanup(),this._disconnected=!0,this.emit(lm.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),$.log(`Socket open`),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){$.log(`Cannot send heartbeat, because socket closed`);return}let e=JSON.stringify({type:um.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){let e=[...this._messagesQueue];this._messagesQueue=[];for(let t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(lm.Error,`Invalid message`);return}if(!this._wsOpen())return;let t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||=(this._cleanup(),!0)}_cleanup(){this._socket&&=(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),void 0),clearTimeout(this._wsPingTimer)}},pm=class{constructor(e){this.connection=e}startConnection(e){let t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===im.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){let n=this.connection,r={ordered:!!e.reliable},i=t.createDataChannel(n.label,r);n._initializeDataChannel(i),this._makeOffer()}else this.handleSDP(`OFFER`,e.sdp)}_startPeerConnection(){$.log(`Creating RTCPeerConnection.`);let e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){let t=this.connection.peer,n=this.connection.connectionId,r=this.connection.type,i=this.connection.provider;$.log(`Listening for ICE candidates.`),e.onicecandidate=e=>{e.candidate&&e.candidate.candidate&&($.log(`Received ICE candidates for ${t}:`,e.candidate),i.socket.send({type:um.Candidate,payload:{candidate:e.candidate,type:r,connectionId:n},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case`failed`:$.log(`iceConnectionState is failed, closing connections to `+t),this.connection.emitError(om.NegotiationFailed,`Negotiation of connection to `+t+` failed.`),this.connection.close();break;case`closed`:$.log(`iceConnectionState is closed, closing connections to `+t),this.connection.emitError(om.ConnectionClosed,`Connection to `+t+` closed.`),this.connection.close();break;case`disconnected`:$.log(`iceConnectionState changed to disconnected on the connection with `+t);break;case`completed`:e.onicecandidate=()=>{}}this.connection.emit(`iceStateChanged`,e.iceConnectionState)},$.log(`Listening for data channel`),e.ondatachannel=e=>{$.log(`Received data channel`);let r=e.channel;i.getConnection(t,n)._initializeDataChannel(r)},$.log(`Listening for remote stream`),e.ontrack=e=>{$.log(`Received remote stream`);let r=e.streams[0],a=i.getConnection(t,n);if(a.type===im.Media){let e=a;this._addStreamToMediaConnection(r,e)}}}cleanup(){$.log(`Cleaning up PeerConnection to `+this.connection.peer);let e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};let t=e.signalingState!==`closed`,n=!1,r=this.connection.dataChannel;r&&(n=!!r.readyState&&r.readyState!==`closed`),(t||n)&&e.close()}async _makeOffer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createOffer(this.connection.options.constraints);$.log(`Created offer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),$.log(`Set localDescription:`,n,`for:${this.connection.peer}`);let r={sdp:n,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===im.Data){let e=this.connection;r={...r,label:e.label,reliable:e.reliable,serialization:e.serialization}}t.socket.send({type:um.Offer,payload:r,dst:this.connection.peer})}catch(e){e!=`OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer`&&(t.emitError(am.WebRTC,e),$.log(`Failed to setLocalDescription, `,e))}}catch(e){t.emitError(am.WebRTC,e),$.log(`Failed to createOffer, `,e)}}async _makeAnswer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createAnswer();$.log(`Created answer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),$.log(`Set localDescription:`,n,`for:${this.connection.peer}`),t.socket.send({type:um.Answer,payload:{sdp:n,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(e){t.emitError(am.WebRTC,e),$.log(`Failed to setLocalDescription, `,e)}}catch(e){t.emitError(am.WebRTC,e),$.log(`Failed to create answer, `,e)}}async handleSDP(e,t){t=new RTCSessionDescription(t);let n=this.connection.peerConnection,r=this.connection.provider;$.log(`Setting remote description`,t);let i=this;try{await n.setRemoteDescription(t),$.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e===`OFFER`&&await i._makeAnswer()}catch(e){r.emitError(am.WebRTC,e),$.log(`Failed to setRemoteDescription, `,e)}}async handleCandidate(e){$.log(`handleCandidate:`,e);try{await this.connection.peerConnection.addIceCandidate(e),$.log(`Added ICE candidate for:${this.connection.peer}`)}catch(e){this.connection.provider.emitError(am.WebRTC,e),$.log(`Failed to handleCandidate, `,e)}}_addTracksToConnection(e,t){if($.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return $.error(`Your browser does't support RTCPeerConnection#addTrack. Ignored.`);e.getTracks().forEach(n=>{t.addTrack(n,e)})}_addStreamToMediaConnection(e,t){$.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}},mm=class extends Yp.EventEmitter{emitError(e,t){$.error(`Error:`,t),this.emit(`error`,new hm(`${e}`,t))}},hm=class extends Error{constructor(e,t){typeof t==`string`?super(t):(super(),Object.assign(this,t)),this.type=e}},gm=class extends mm{get open(){return this._open}constructor(e,t,n){super(),this.peer=e,this.provider=t,this.options=n,this._open=!1,this.metadata=n.metadata}},_m=class e extends gm{static#e=this.ID_PREFIX=`mc_`;get type(){return im.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(t,n,r){super(t,n,r),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||e.ID_PREFIX+qp.randomToken(),this._negotiator=new pm(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{$.log(`DC#${this.connectionId} dc connection success`),this.emit(`willCloseOnRemote`)},this.dataChannel.onclose=()=>{$.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){$.log(`Receiving stream`,e),this._remoteStream=e,super.emit(`stream`,e)}handleMessage(e){let t=e.type,n=e.payload;switch(e.type){case um.Answer:this._negotiator.handleSDP(t,n.sdp),this._open=!0;break;case um.Candidate:this._negotiator.handleCandidate(n.candidate);break;default:$.warn(`Unrecognized message type:${t} from peer:${this.peer}`)}}answer(e,t={}){if(this._localStream){$.warn(`Local stream already exists on this MediaConnection. Are you answering a call twice?`);return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});let n=this.provider._getMessages(this.connectionId);for(let e of n)this.handleMessage(e);this._open=!0}close(){this._negotiator&&=(this._negotiator.cleanup(),null),this._localStream=null,this._remoteStream=null,this.provider&&=(this.provider._removeConnection(this),null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit(`close`))}},vm=class{constructor(e){this._options=e}_buildRequest(e){let t=this._options.secure?`https`:`http`,{host:n,port:r,path:i,key:a}=this._options,o=new URL(`${t}://${n}:${r}${i}${a}/${e}`);return o.searchParams.set(`ts`,`${Date.now()}${Math.random()}`),o.searchParams.set(`version`,dm),fetch(o.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{let e=await this._buildRequest(`id`);if(e.status!==200)throw Error(`Error. Status:${e.status}`);return e.text()}catch(e){$.error(`Error retrieving ID`,e);let t=``;throw this._options.path===`/`&&this._options.host!==qp.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),Error(`Could not get an ID from the server.`+t)}}async listAllPeers(){try{let e=await this._buildRequest(`peers`);if(e.status!==200){if(e.status===401){let e=``;throw e=this._options.host===qp.CLOUD_HOST?`It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.`:"You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",Error(`It doesn't look like you have permission to list peers IDs. `+e)}throw Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw $.error(`Error retrieving list peers`,e),Error(`Could not get list peers from the server.`+e)}}},ym=class e extends gm{static#e=this.ID_PREFIX=`dc_`;static#t=this.MAX_BUFFERED_AMOUNT=8388608;get type(){return im.Data}constructor(t,n,r){super(t,n,r),this.connectionId=this.options.connectionId||e.ID_PREFIX+Gp(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new pm(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{$.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit(`open`)},this.dataChannel.onmessage=e=>{$.log(`DC#${this.connectionId} dc onmessage:`,e.data)},this.dataChannel.onclose=()=>{$.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._negotiator&&=(this._negotiator.cleanup(),null),this.provider&&=(this.provider._removeConnection(this),null),this.dataChannel&&=(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,null),this.open&&(this._open=!1,super.emit(`close`))}send(e,t=!1){if(!this.open){this.emitError(sm.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){let t=e.payload;switch(e.type){case um.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case um.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:$.warn(`Unrecognized message type:`,e.type,`from peer:`,this.peer)}}},bm=class extends ym{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType=`arraybuffer`,this.dataChannel.addEventListener(`message`,e=>this._handleDataMessage(e))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>ym.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(e){return $.error(`DC#:${this.connectionId} Error when sending:`,e),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;let e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}},xm=class extends bm{close(e){super.close(e),this._chunkedData={}}constructor(e,t,n){super(e,t,n),this.chunker=new Bp,this.serialization=cm.Binary,this._chunkedData={}}_handleDataMessage({data:e}){let t=Of(e),n=t.__peerData;if(n){if(n.type===`close`){this.close();return}this._handleChunk(t);return}this.emit(`data`,t)}_handleChunk(e){let t=e.__peerData,n=this._chunkedData[t]||{data:[],count:0,total:e.total};if(n.data[e.n]=new Uint8Array(e.data),n.count++,this._chunkedData[t]=n,n.total===n.count){delete this._chunkedData[t];let e=Vp(n.data);this._handleDataMessage({data:e})}}_send(e,t){let n=kf(e);if(n instanceof Promise)return this._send_blob(n);if(!t&&n.byteLength>this.chunker.chunkedMTU){this._sendChunks(n);return}this._bufferedSend(n)}async _send_blob(e){let t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){let t=this.chunker.chunk(e);$.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(let e of t)this.send(e,!0)}},Sm=class extends bm{_handleDataMessage({data:e}){super.emit(`data`,e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=cm.None}},Cm=class extends bm{_handleDataMessage({data:e}){let t=this.parse(this.decoder.decode(e)),n=t.__peerData;if(n&&n.type===`close`){this.close();return}this.emit(`data`,t)}_send(e,t){let n=this.encoder.encode(this.stringify(e));if(n.byteLength>=qp.chunkedMTU){this.emitError(sm.MessageToBig,`Message too big for JSON channel`);return}this._bufferedSend(n)}constructor(...e){super(...e),this.serialization=cm.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}},wm=class e extends mm{static#e=this.DEFAULT_KEY=`peerjs`;get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){let e=Object.create(null);for(let[t,n]of this._connections)e[t]=n;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(t,n){super(),this._serializers={raw:Sm,json:Cm,binary:xm,"binary-utf8":xm,default:xm},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let r;if(t&&t.constructor==Object?n=t:t&&(r=t.toString()),n={debug:0,host:qp.CLOUD_HOST,port:qp.CLOUD_PORT,path:`/`,key:e.DEFAULT_KEY,token:qp.randomToken(),config:qp.defaultConfig,referrerPolicy:`strict-origin-when-cross-origin`,serializers:{},...n},this._options=n,this._serializers={...this._serializers,...this.options.serializers},this._options.host===`/`&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!==`/`&&(this._options.path=`/`+this._options.path),this._options.path[this._options.path.length-1]!==`/`&&(this._options.path+=`/`)),this._options.secure===void 0&&this._options.host!==qp.CLOUD_HOST?this._options.secure=qp.isSecure():this._options.host==qp.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&$.setLogFunction(this._options.logFunction),$.logLevel=this._options.debug||0,this._api=new vm(n),this._socket=this._createServerConnection(),!qp.supports.audioVideo&&!qp.supports.data){this._delayedAbort(am.BrowserIncompatible,`The current browser does not support WebRTC`);return}if(r&&!qp.validateId(r)){this._delayedAbort(am.InvalidID,`ID "${r}" is invalid`);return}r?this._initialize(r):this._api.retrieveId().then(e=>this._initialize(e)).catch(e=>this._abort(am.ServerError,e))}_createServerConnection(){let e=new fm(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(lm.Message,e=>{this._handleMessage(e)}),e.on(lm.Error,e=>{this._abort(am.SocketError,e)}),e.on(lm.Disconnected,()=>{this.disconnected||(this.emitError(am.Network,`Lost connection to server.`),this.disconnect())}),e.on(lm.Close,()=>{this.disconnected||this._abort(am.SocketClosed,`Underlying socket is already closed.`)}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){let t=e.type,n=e.payload,r=e.src;switch(t){case um.Open:this._lastServerId=this.id,this._open=!0,this.emit(`open`,this.id);break;case um.Error:this._abort(am.ServerError,n.msg);break;case um.IdTaken:this._abort(am.UnavailableID,`ID "${this.id}" is taken`);break;case um.InvalidKey:this._abort(am.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case um.Leave:$.log(`Received leave message from ${r}`),this._cleanupPeer(r),this._connections.delete(r);break;case um.Expire:this.emitError(am.PeerUnavailable,`Could not connect to peer ${r}`);break;case um.Offer:{let e=n.connectionId,t=this.getConnection(r,e);if(t&&(t.close(),$.warn(`Offer received for existing Connection ID:${e}`)),n.type===im.Media){let i=new _m(r,this,{connectionId:e,_payload:n,metadata:n.metadata});t=i,this._addConnection(r,t),this.emit(`call`,i)}else if(n.type===im.Data){let i=new this._serializers[n.serialization](r,this,{connectionId:e,_payload:n,metadata:n.metadata,label:n.label,serialization:n.serialization,reliable:n.reliable});t=i,this._addConnection(r,t),this.emit(`connection`,i)}else{$.warn(`Received malformed connection type:${n.type}`);return}let i=this._getMessages(e);for(let e of i)t.handleMessage(e);break}default:{if(!n){$.warn(`You received a malformed message from ${r} of type ${t}`);return}let i=n.connectionId,a=this.getConnection(r,i);a&&a.peerConnection?a.handleMessage(e):i?this._storeMessage(i,e):$.warn(`You received an unrecognized message:`,e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){let t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:`default`,...t},this.disconnected){$.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.`),this.emitError(am.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}let n=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,n),n}call(e,t,n={}){if(this.disconnected){$.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.`),this.emitError(am.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}if(!t){$.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}let r=new _m(e,this,{...n,_stream:t});return this._addConnection(e,r),r}_addConnection(e,t){$.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){let t=this._connections.get(e.peer);if(t){let n=t.indexOf(e);n!==-1&&t.splice(n,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){let n=this._connections.get(e);if(!n)return null;for(let e of n)if(e.connectionId===t)return e;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){$.error(`Aborting!`),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||($.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit(`close`))}_cleanup(){for(let e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){let t=this._connections.get(e);if(t)for(let e of t)e.close()}disconnect(){if(this.disconnected)return;let e=this.id;$.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit(`disconnected`,e)}reconnect(){if(this.disconnected&&!this.destroyed)$.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else if(this.destroyed)throw Error(`This peer cannot reconnect to the server. It has already been destroyed.`);else if(!this.disconnected&&!this.open)$.error(`In a hurry? We're still trying to make the initial connection!`);else throw Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}listAllPeers(e=e=>{}){this._api.listAllPeers().then(t=>e(t)).catch(e=>this._abort(am.ServerError,e))}},Tm=class{constructor(e,t){this.peer=null,this.myPeerId=null,this.roomId=null,this.isHost=!1,this.connections=new Map,this.players=new Map,this.onMessageCallback=e,this.onPlayerListUpdate=t,this.broadcastInterval=null,this.lastSentStateTime=0}init(){return new Promise((e,t)=>{let n=Math.random().toString(36).substring(2,7).toUpperCase();this.peer=new wm(`apex-${n}`,{debug:1,config:{iceServers:[{urls:`stun:stun.l.google.com:19302`},{urls:`stun:stun1.l.google.com:19302`},{urls:`stun:stun2.l.google.com:19302`}]}}),this.peer.on(`open`,t=>{this.myPeerId=t,console.log(`[Multiplayer] Connected to signaling with ID:`,t),e(t)}),this.peer.on(`connection`,e=>{this.handleIncomingConnection(e)}),this.peer.on(`error`,e=>{if(console.warn(`[Multiplayer] Peer error:`,e),e.type===`unavailable-id`){let e=`apex-${Date.now().toString(36).slice(-5).toUpperCase()}`;this.peer=new wm(e)}})})}createRoom(e=`Player 1`,t=0,n=0){return this.isHost=!0,this.roomId=this.myPeerId,this.players.set(this.myPeerId,{id:this.myPeerId,name:e,carIndex:t,isHost:!0,ready:!0,finished:!1,finishTime:null}),this.selectedMap=n,this.notifyPlayersChanged(),this.roomId}joinRoom(e,t=`Player 2`,n=1){return new Promise((r,i)=>{this.isHost=!1;let a=e.trim();a.startsWith(`apex-`)||(a=`apex-${a}`),this.roomId=a,console.log(`[Multiplayer] Connecting to host: ${a}...`);let o=this.peer.connect(a,{reliable:!0}),s=setTimeout(()=>{i(Error(`Connection timed out. Check room code.`))},9e3);o.on(`open`,()=>{clearTimeout(s),this.connections.set(a,o),o.send({type:`JOIN`,playerId:this.myPeerId,name:t,carIndex:n}),this.setupDataListeners(o),r(a)}),o.on(`error`,e=>{clearTimeout(s),i(e)})})}handleIncomingConnection(e){if(this.players.size>=6){e.send({type:`ERROR`,message:`Room is full (max 6 players)!`}),setTimeout(()=>e.close(),500);return}e.on(`open`,()=>{this.connections.set(e.peer,e),this.setupDataListeners(e)})}setupDataListeners(e){e.on(`data`,t=>{this.handlePacket(t,e)}),e.on(`close`,()=>{console.log(`[Multiplayer] Peer disconnected: ${e.peer}`),this.connections.delete(e.peer),this.players.delete(e.peer),this.notifyPlayersChanged(),this.onMessageCallback&&this.onMessageCallback({type:`PLAYER_DISCONNECTED`,peerId:e.peer})})}handlePacket(e,t){switch(e.type){case`JOIN`:if(this.isHost){let t=e.carIndex,n=Array.from(this.players.values()).map(e=>e.carIndex);if(n.includes(t)){for(let e=0;e<6;e++)if(!n.includes(e)){t=e;break}}this.players.set(e.playerId,{id:e.playerId,name:e.name,carIndex:t,isHost:!1,ready:!0,finished:!1,finishTime:null}),this.broadcastRoster(),this.notifyPlayersChanged()}break;case`ROSTER_SYNC`:this.players.clear(),e.players.forEach(e=>this.players.set(e.id,e)),e.mapIndex!==void 0&&(this.selectedMap=e.mapIndex),this.notifyPlayersChanged();break;case`CAR_SELECT`:{let t=this.players.get(e.playerId);t&&(t.carIndex=e.carIndex,this.isHost&&this.broadcastRoster(),this.notifyPlayersChanged());break}case`START_RACE`:this.onMessageCallback&&this.onMessageCallback(e);break;case`TELEMETRY`:this.isHost&&this.broadcastExcept(e,t.peer),this.onMessageCallback&&this.onMessageCallback(e);break;case`RACE_FINISH`:{let t=this.players.get(e.playerId);t&&(t.finished=!0,t.finishTime=e.time,t.rank=e.rank),this.isHost&&this.broadcast(e),this.onMessageCallback&&this.onMessageCallback(e);break}default:this.onMessageCallback&&this.onMessageCallback(e)}}broadcastRoster(){let e={type:`ROSTER_SYNC`,mapIndex:this.selectedMap,players:Array.from(this.players.values())};this.broadcast(e)}broadcast(e){this.connections.forEach(t=>{t.open&&t.send(e)})}broadcastExcept(e,t){this.connections.forEach((n,r)=>{r!==t&&n.open&&n.send(e)})}sendTelemetry(e){let t={type:`TELEMETRY`,playerId:this.myPeerId,...e};if(this.isHost)this.broadcast(t);else{let e=this.connections.get(this.roomId);e&&e.open&&e.send(t)}}notifyPlayersChanged(){this.onPlayerListUpdate&&this.onPlayerListUpdate(Array.from(this.players.values()),this.isHost,this.selectedMap)}getShareableLink(){let e=new URL(window.location.href),t=this.roomId.replace(`apex-`,``);return e.searchParams.set(`room`,t),e.toString()}},Em=class{constructor(){this.container=document.getElementById(`canvas-container`),this.gameMode=`solo`,this.soloTourStage=0,this.soloTourTimes=[null,null,null],this.activeMapIndex=0,this.selectedCarIndex=0,this.activeCheckpoint=1,this.totalCheckpoints=7,this.raceStartTime=null,this.raceFinished=!1,this.isCountingDown=!1,this.topSpeedReached=0,this.elapsedTime=0,this.remoteCars=new Map,this.lastTelemetrySend=0,this.initThree(),this.initEntities(),this.setup3DWaypointArrow(),this.setupInputs(),this.setupNetwork(),this.setupUI(),this.clock=new Es,this.animate=this.animate.bind(this),requestAnimationFrame(this.animate)}initThree(){this.scene=new Jn,this.scene.fog=new qn(659229,35e-5);let e=window.innerWidth/window.innerHeight;this.camera=new Qo(62,e,.1,1600),this.cameraTarget=new z,this.renderer=new Ku({antialias:!0,powerPreference:`high-performance`}),this.renderer.setSize(window.innerWidth,window.innerHeight);let t=/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||`ontouchstart`in window;this.isMobile=t,this.renderer.setPixelRatio(t?Math.min(window.devicePixelRatio,1.25):Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=+!t,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.3,this.container.appendChild(this.renderer.domElement),Tf(this.renderer,this.scene,this.activeMapIndex),this.ambientLight=new os(16772565,1.4),this.scene.add(this.ambientLight),this.sunLight=new as(16638023,2.6),this.sunLight.position.set(90,80,-110),this.sunLight.castShadow=!0,this.sunLight.shadow.mapSize.width=1024,this.sunLight.shadow.mapSize.height=1024,this.sunLight.shadow.camera.near=10,this.sunLight.shadow.camera.far=500,this.sunLight.shadow.camera.left=-160,this.sunLight.shadow.camera.right=160,this.sunLight.shadow.camera.top=160,this.sunLight.shadow.camera.bottom=-160,this.sunLight.shadow.bias=-4e-4,this.scene.add(this.sunLight),window.addEventListener(`resize`,()=>this.onResize())}initEntities(){this.track=new Cf(this.scene,this.activeMapIndex),this.car=new of(this.scene),this.hud=new wf,this.resetCarToStart(),this.track.highlightCheckpoint(this.activeCheckpoint)}resetCarToStart(){if(this.track&&this.track.roadPoints&&this.track.roadPoints.length>0){let e=this.track.roadPoints[0],t=this.track.getHeadingAt(0);this.car.reset(e.x,e.z,t);let n=new z(Math.sin(t),0,Math.cos(t)),r=n.clone().multiplyScalar(-7.2);this.camera.position.copy(this.car.position).add(r).add(new z(0,2.8,0)),this.cameraTarget.copy(this.car.position).addScaledVector(n,8),this.camera.lookAt(this.cameraTarget)}else this.car.reset(0,35,Math.PI)}setup3DWaypointArrow(){this.arrowGroup=new zn;let e=new Ma(.35,1.2,16);e.rotateX(Math.PI/2);let t=new K(e,new G({color:61695,transparent:!0,opacity:.95}));this.arrowGroup.add(t);let n=new Ha(.6,.75,24);n.rotateX(-Math.PI/2);let r=new K(n,new G({color:61695,side:2,transparent:!0,opacity:.65}));this.arrowGroup.add(r),this.scene.add(this.arrowGroup)}setupNetwork(){this.network=new Tm(e=>this.handleNetworkMessage(e),(e,t,n)=>this.updateLobbyPlayerList(e,t,n)),this.network.init().then(e=>{console.log(`Peer connected, ID:`,e);let t=this.network.createRoom(`Player 1 (Host)`,this.selectedCarIndex,this.activeMapIndex),n=document.getElementById(`room-code-display`);n&&(n.textContent=t.replace(`apex-`,``).toUpperCase());let r=new URLSearchParams(window.location.search).get(`room`);if(r){document.getElementById(`mode-selection-modal`).classList.remove(`active`),document.getElementById(`lobby-modal`).classList.add(`active`),document.getElementById(`tab-join`).click();let e=document.getElementById(`join-room-input`);e&&(e.value=r.toUpperCase()),this.joinExistingRoom(r)}})}handleNetworkMessage(e){switch(e.type){case`START_RACE`:this.gameMode=`multiplayer`,e.mapIndex!==void 0&&e.mapIndex!==this.activeMapIndex&&this.switchMap(e.mapIndex),document.getElementById(`mode-selection-modal`).classList.remove(`active`),document.getElementById(`lobby-modal`).classList.remove(`active`),this.startRaceSequence();break;case`TELEMETRY`:{let t=this.remoteCars.get(e.playerId);t&&t.updateTelemetry(e);break}case`PLAYER_DISCONNECTED`:{let t=this.remoteCars.get(e.peerId);t&&(t.destroy(),this.remoteCars.delete(e.peerId));break}case`RACE_FINISH`:this.raceFinished&&this.refreshPodiumResults()}}updateLobbyPlayerList(e,t,n){let r=document.getElementById(`player-roster`),i=document.getElementById(`player-count`);i&&(i.textContent=e.length),r&&(r.innerHTML=``,e.forEach(e=>{let t=af[e.carIndex]||af[0],n=e.id===this.network.myPeerId,i=document.createElement(`div`);if(i.className=`roster-item ${n?`me`:``}`,i.innerHTML=`
          <span class="player-status-icon">${e.isHost?`👑`:`🏎️`}</span>
          <span class="player-name">${e.name} ${n?`(You)`:``}</span>
          <span class="player-car-tag">${t.name.split(` `)[0]}</span>
        `,r.appendChild(i),!n&&!this.remoteCars.has(e.id)){let t=new sf(this.scene,e);this.remoteCars.set(e.id,t)}})),n!==void 0&&n!==this.activeMapIndex&&this.switchMap(n)}switchMap(e){this.activeMapIndex=e,this.track.setMap(e),Tf(this.renderer,this.scene,e),this.resetCarToStart(),this.activeCheckpoint=1,this.track.highlightCheckpoint(this.activeCheckpoint);let t=Sf[e],n=document.getElementById(`map-name-tag`);n&&t&&(n.textContent=this.gameMode===`solo`?`STAGE ${this.soloTourStage+1}/3 • ${t.name.toUpperCase()}`:t.name.toUpperCase())}startRaceSequence(){this.isCountingDown=!0,this.raceFinished=!1,this.activeCheckpoint=1,this.topSpeedReached=0,this.resetCarToStart(),this.track.highlightCheckpoint(this.activeCheckpoint);let e=this.gameMode===`solo`?`STAGE ${this.soloTourStage+1} / 3`:`WARMING UP TIRES...`;this.hud.showPreparingMessage(e),this.car.onModelReady(()=>{this.hud.startCountdown(()=>{this.isCountingDown=!1,this.raceStartTime=performance.now()})})}setupInputs(){let e={KeyW:`forward`,ArrowUp:`forward`,KeyS:`backward`,ArrowDown:`backward`,KeyA:`left`,ArrowLeft:`left`,KeyD:`right`,ArrowRight:`right`,Space:`brake`,ShiftLeft:`nitro`,ShiftRight:`nitro`};window.addEventListener(`keydown`,t=>{if(t.code===`KeyR`){this.resetCarToCheckpoint();return}let n=e[t.code];n&&(this.car.inputs[n]=!0)}),window.addEventListener(`keyup`,t=>{let n=e[t.code];n&&(this.car.inputs[n]=!1)});let t=(e,t)=>{let n=document.getElementById(e);if(!n)return;let r=e=>{e.preventDefault(),this.car.inputs[t]=!0},i=e=>{e.preventDefault(),this.car.inputs[t]=!1};n.addEventListener(`touchstart`,r,{passive:!1}),n.addEventListener(`touchend`,i,{passive:!1}),n.addEventListener(`mousedown`,r),n.addEventListener(`mouseup`,i)};t(`touch-left`,`left`),t(`touch-right`,`right`),t(`touch-gas`,`forward`),t(`touch-brake`,`backward`),t(`touch-handbrake`,`brake`),t(`touch-nitro`,`nitro`),window.addEventListener(`pointerdown`,()=>rf.ensureContext(),{once:!0})}setupUI(){document.getElementById(`btn-start-solo-tour`).addEventListener(`click`,()=>{this.gameMode=`solo`,this.soloTourStage=0,this.soloTourTimes=[null,null,null],document.getElementById(`mode-selection-modal`).classList.remove(`active`),this.switchMap(0),this.startRaceSequence()}),document.getElementById(`btn-open-multi-lobby`).addEventListener(`click`,()=>{this.gameMode=`multiplayer`,document.getElementById(`mode-selection-modal`).classList.remove(`active`),document.getElementById(`lobby-modal`).classList.add(`active`)}),document.getElementById(`open-mode-btn`).addEventListener(`click`,()=>{document.getElementById(`mode-selection-modal`).classList.add(`active`)}),document.getElementById(`open-lobby-btn`).addEventListener(`click`,()=>{document.getElementById(`lobby-modal`).classList.add(`active`)}),document.getElementById(`close-lobby-btn`).addEventListener(`click`,()=>{document.getElementById(`lobby-modal`).classList.remove(`active`),document.getElementById(`mode-selection-modal`).classList.add(`active`)}),document.getElementById(`reset-car-btn`).addEventListener(`click`,()=>{this.resetCarToCheckpoint()});let e=document.getElementById(`mute-btn`);e.addEventListener(`click`,()=>{rf.muted=!rf.muted,e.querySelector(`span`).textContent=rf.muted?`Audio: OFF`:`Audio: ON`});let t=document.getElementById(`tab-host`),n=document.getElementById(`tab-join`),r=document.getElementById(`host-panel`),i=document.getElementById(`join-panel`);t.addEventListener(`click`,()=>{t.classList.add(`active`),n.classList.remove(`active`),r.style.display=`block`,i.style.display=`none`}),n.addEventListener(`click`,()=>{n.classList.add(`active`),t.classList.remove(`active`),i.style.display=`block`,r.style.display=`none`}),document.querySelectorAll(`.map-card`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`.map-card`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let t=parseInt(e.dataset.map,10);this.switchMap(t),this.network&&this.network.isHost&&(this.network.selectedMap=t,this.network.broadcastRoster())})}),document.querySelectorAll(`.car-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=parseInt(e.dataset.car,10);if(this.selectedCarIndex=t,this.car.setCarConfig(t),document.querySelectorAll(`.car-card`).forEach(e=>{parseInt(e.dataset.car,10)===t?e.classList.add(`active`):e.classList.remove(`active`)}),this.network){let e=this.network.players.get(this.network.myPeerId);e&&(e.carIndex=t,this.network.broadcast({type:`CAR_SELECT`,playerId:this.network.myPeerId,carIndex:t}),this.network.notifyPlayersChanged())}})});let a=document.getElementById(`copy-link-btn`),o=document.getElementById(`copy-feedback`);a.addEventListener(`click`,()=>{let e=this.network.getShareableLink();navigator.clipboard.writeText(e).then(()=>{o.textContent=`Link copied to clipboard! Share with up to 5 friends 📋`,setTimeout(()=>{o.textContent=``},4e3)}).catch(()=>{o.textContent=e})}),document.getElementById(`start-race-btn`).addEventListener(`click`,()=>{this.gameMode=`multiplayer`,document.getElementById(`lobby-modal`).classList.remove(`active`),this.network.broadcast({type:`START_RACE`,mapIndex:this.activeMapIndex}),this.startRaceSequence()}),document.getElementById(`join-room-btn`).addEventListener(`click`,()=>{let e=document.getElementById(`join-room-input`).value;e&&this.joinExistingRoom(e)}),document.getElementById(`restart-tour-btn`).addEventListener(`click`,()=>{document.getElementById(`victory-modal`).classList.remove(`active`),this.gameMode=`solo`,this.soloTourStage=0,this.soloTourTimes=[null,null,null],this.switchMap(0),this.startRaceSequence()}),document.getElementById(`switch-to-multi-btn`).addEventListener(`click`,()=>{document.getElementById(`victory-modal`).classList.remove(`active`),document.getElementById(`lobby-modal`).classList.add(`active`)})}joinExistingRoom(e){let t=document.getElementById(`join-status`);t.textContent=`Connecting to room host...`,t.style.color=`#38bdf8`,this.network.joinRoom(e,`Player ${Math.floor(Math.random()*80+2)}`,this.selectedCarIndex).then(e=>{t.textContent=`Connected successfully! Waiting for host to launch race 🏁`,t.style.color=`#22c55e`,document.getElementById(`tab-host`).click()}).catch(e=>{t.textContent=`Connection failed: ${e.message||`Room not found`}`,t.style.color=`#ef4444`})}resetCarToCheckpoint(){let e=this.track.checkpoints.find(e=>e.id===this.activeCheckpoint);if(e&&e.roadIdx!==void 0){let t=this.track.pointsCount||600,n=(e.roadIdx-14+t)%t,r=this.track.roadPoints[n],i=this.track.getHeadingAt(n);this.car.reset(r.x,r.z,i)}else if(e){let t=new z(Math.sin(e.rotation),0,Math.cos(e.rotation)),n=e.pos.clone().addScaledVector(t,-16);this.car.reset(n.x,n.z,e.rotation)}else this.resetCarToStart();let t=new z(Math.sin(this.car.heading),0,Math.cos(this.car.heading)),n=t.clone().multiplyScalar(-7.2);this.camera.position.copy(this.car.position).add(n).add(new z(0,2.8,0)),this.cameraTarget.copy(this.car.position).addScaledVector(t,8),this.camera.lookAt(this.cameraTarget)}checkCheckpointProgress(){if(this.raceFinished||this.isCountingDown)return;let e=this.track.checkpoints.find(e=>e.id===this.activeCheckpoint);if(!e)return;let t=this.car.position.distanceTo(e.pos);this.hud.updateCheckpointStatus(this.activeCheckpoint,this.totalCheckpoints,t,e.name),this.arrowGroup&&(this.arrowGroup.position.copy(this.car.position).add(new z(0,2.6,0)),this.arrowGroup.lookAt(e.pos.x,2.6,e.pos.z),this.arrowGroup.position.y+=Math.sin(performance.now()*.006)*.15),t<e.radius&&(rf.playCheckpointChime(),this.hud.showSplitTime(e.id,e.name,this.elapsedTime),this.activeCheckpoint<this.totalCheckpoints?(this.activeCheckpoint++,this.track.highlightCheckpoint(this.activeCheckpoint)):this.finishRace())}finishRace(){if(this.raceFinished=!0,rf.playVictoryFanfare(),Ju({particleCount:220,spread:100,origin:{y:.6}}),this.gameMode===`solo`){if(this.soloTourTimes[this.soloTourStage]=this.elapsedTime,this.soloTourStage<2){this.showStageTransition(this.soloTourStage);return}this.showFinalChampionshipPodium()}else{let e=this.network.players.get(this.network.myPeerId);e&&(e.finished=!0,e.finishTime=this.elapsedTime),this.network.broadcast({type:`RACE_FINISH`,playerId:this.network.myPeerId,time:this.elapsedTime}),this.refreshPodiumResults(),setTimeout(()=>{document.getElementById(`victory-modal`).classList.add(`active`)},1200)}}showStageTransition(e){let t=document.getElementById(`stage-transition-modal`),n=document.getElementById(`trans-title`),r=document.getElementById(`trans-time`),i=document.getElementById(`trans-next`),a=document.getElementById(`trans-bar-fill`);n.textContent=`STAGE ${e+1} COMPLETED! 🏁`,r.textContent=this.hud.formatTime(this.elapsedTime),i.textContent=[`🚀 REDIRECTING TO STAGE 2: NEO-TOKYO MIDNIGHT...`,`🌋 REDIRECTING TO STAGE 3: VOLCANIC INFERNO...`][e],a.style.transition=`none`,a.style.width=`0%`,t.classList.add(`active`),setTimeout(()=>{a.style.transition=`width 2.6s linear`,a.style.width=`100%`},50),setTimeout(()=>{t.classList.remove(`active`),this.soloTourStage++,this.switchMap(this.soloTourStage),this.startRaceSequence()},2800)}showFinalChampionshipPodium(){let e=document.getElementById(`victory-modal`),t=document.getElementById(`three-maps-breakdown`);t.style.display=`block`;let n=this.soloTourTimes[0]||74.2,r=this.soloTourTimes[1]||78.5,i=this.soloTourTimes[2]||82.1,a=n+r+i;document.getElementById(`bdown-map1`).textContent=this.hud.formatTime(n),document.getElementById(`bdown-map2`).textContent=this.hud.formatTime(r),document.getElementById(`bdown-map3`).textContent=this.hud.formatTime(i),document.getElementById(`bdown-total`).textContent=this.hud.formatTime(a),document.getElementById(`podium-badge`).textContent=`GRAND PRIX 3-MAP CHAMPIONSHIP`,document.getElementById(`podium-title`).textContent=`WORLD CHAMPION PODIUM 🏆`;let o=af[this.selectedCarIndex];document.getElementById(`gold-name`).textContent=`YOU`,document.getElementById(`gold-time`).textContent=this.hud.formatTime(a),document.getElementById(`gold-car`).textContent=o.name,document.getElementById(`silver-name`).textContent=`K. RÄIKKÖNEN`,document.getElementById(`silver-time`).textContent=this.hud.formatTime(a+4.85),document.getElementById(`silver-car`).textContent=`Pagani Huayra BC`,document.getElementById(`bronze-name`).textContent=`M. VERSTAPPEN`,document.getElementById(`bronze-time`).textContent=this.hud.formatTime(a+9.32),document.getElementById(`bronze-car`).textContent=`Jesko Absolut`,document.getElementById(`fin-time`).textContent=this.hud.formatTime(a),document.getElementById(`fin-speed`).textContent=`${Math.round(this.topSpeedReached*3.6)} KM/H`,document.getElementById(`fin-map`).textContent=`ALL 3 MAPS CLEARED`,document.getElementById(`fin-rank`).textContent=`1ST GOLD 🏆`,setTimeout(()=>{e.classList.add(`active`)},1200)}refreshPodiumResults(){let e=this.hud.formatTime(this.elapsedTime),t=Math.round(this.topSpeedReached*3.6),n=af[this.selectedCarIndex],r=Sf[this.activeMapIndex],i=document.getElementById(`three-maps-breakdown`);i.style.display=`none`;let a=[];this.network.players.size>1?(a=Array.from(this.network.players.values()).map(e=>({name:e.name,car:(af[e.carIndex]||af[0]).name,time:e.finishTime?e.finishTime:this.elapsedTime+Math.random()*4+1.2,isMe:e.id===this.network.myPeerId})),a.sort((e,t)=>e.time-t.time)):a=[{name:`YOU`,car:n.name,time:this.elapsedTime,isMe:!0},{name:`K. RÄIKKÖNEN`,car:`Pagani Huayra BC`,time:this.elapsedTime+1.84,isMe:!1},{name:`M. VERSTAPPEN`,car:`Jesko Absolut`,time:this.elapsedTime+3.42,isMe:!1}];let o=a[0]||{name:`YOU`,car:n.name,time:this.elapsedTime},s=a[1]||{name:`RIVAL 1`,car:`Pagani Huayra BC`,time:this.elapsedTime+2.1},c=a[2]||{name:`RIVAL 2`,car:`Jesko Absolut`,time:this.elapsedTime+4.5};document.getElementById(`gold-name`).textContent=o.name,document.getElementById(`gold-time`).textContent=this.hud.formatTime(o.time),document.getElementById(`gold-car`).textContent=o.car,document.getElementById(`silver-name`).textContent=s.name,document.getElementById(`silver-time`).textContent=this.hud.formatTime(s.time),document.getElementById(`silver-car`).textContent=s.car,document.getElementById(`bronze-name`).textContent=c.name,document.getElementById(`bronze-time`).textContent=this.hud.formatTime(c.time),document.getElementById(`bronze-car`).textContent=c.car,document.getElementById(`fin-time`).textContent=e,document.getElementById(`fin-speed`).textContent=`${t} KM/H`,document.getElementById(`fin-map`).textContent=r.badge;let l=a.findIndex(e=>e.isMe),u=[`1ST GOLD 🏆`,`2ND SILVER 🥈`,`3RD BRONZE 🥉`,`4TH PLACE`,`5TH PLACE`,`6TH PLACE`];document.getElementById(`fin-rank`).textContent=u[l>=0?l:0]}updateCamera(e){let t=this.car.position,n=new z(Math.sin(this.car.heading),0,Math.cos(this.car.heading)),r=this.car.speed,i=Math.min(28,6+r*.28),a=t.clone().addScaledVector(n,i);this.cameraTarget.lerp(a,e*9);let o=n.clone().multiplyScalar(-1),s=Math.min(1.2,r/139),c=7.2+s*3.5,l=2.8+s*.8,u=t.clone().addScaledVector(o,c).add(new z(0,l,0));this.camera.position.lerp(u,e*11),this.camera.lookAt(this.cameraTarget);let d=this.car.isNitro?84:62+s*16;this.camera.fov=Ht.lerp(this.camera.fov,d,e*6),this.camera.updateProjectionMatrix();let f=document.getElementById(`speed-overlay`);f&&(this.car.isNitro||r>100?f.classList.add(`active`):f.classList.remove(`active`))}onResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(this.isMobile?Math.min(window.devicePixelRatio,1.25):Math.min(window.devicePixelRatio,2))}animate(){requestAnimationFrame(this.animate);let e=Math.min(this.clock.getDelta(),.05);!this.raceFinished&&!this.isCountingDown&&this.raceStartTime&&(this.elapsedTime=(performance.now()-this.raceStartTime)/1e3,this.hud.updateTimer(this.elapsedTime)),this.car.update(e,this.track),this.car.speed>this.topSpeedReached&&(this.topSpeedReached=this.car.speed);let t=performance.now();t-this.lastTelemetrySend>50&&this.network&&(this.lastTelemetrySend=t,this.network.sendTelemetry({x:this.car.position.x,y:this.car.position.y,z:this.car.position.z,heading:this.car.heading,speed:this.car.speed,steerAngle:this.car.steerAngle,isNitro:this.car.isNitro,checkpoint:this.activeCheckpoint})),this.remoteCars.forEach(t=>t.update(e)),this.track.update(e),this.checkCheckpointProgress(),this.updateCamera(e),this.hud.updateDashboard(this.car.forwardSpeed,this.car.rpm,this.car.currentGear,this.car.isNitro,this.car.nitroFuel),this.hud.drawMinimap(this.car.position,this.car.heading,this.track.checkpoints,this.activeCheckpoint),this.renderer.render(this.scene,this.camera)}};window.addEventListener(`DOMContentLoaded`,()=>{window.game=new Em});